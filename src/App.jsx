...
const SEED = [
  ...
  // ── RCM SOPs FROM SHAREPOINT ──
  {
    id:"sop-r01", policyNumber:"FDH-BILL-2026-007", title:"e-Checks Deposits (MPX eChecks)",
    category:"Billing", status:"approved", version:"1.0",
    createdAt:"2026-03-09T00:00:00Z", updatedAt:"2026-03-09T00:00:00Z",
    createdBy:"Jenny Organista", approvedAt:"2026-03-09T00:00:00Z", approvedBy:"RCM Director",
    tags:["eChecks","MPX","deposits","insurance","RCM","billing"],
    content:"PURPOSE\nDefine the procedure for handling MPX eChecks received weekly from insurance companies.\n\nPROCEDURE\n1. Receive Email: Every Monday, receive email with subject line 'MPX CHECKS TO DEPOSIT - [Date]' containing scanned files to review and process.\n2. Review Attachments: Scans will include EOBs (details of insurance payments) and files labeled 'Checks' (electronic checks to be deposited).\n3. Print the Checks: Print files labeled 'Checks' for your location. Do not print files with checks listed as 'voided' - those are EOBs only.\n4. Deposit the Checks: Deposit printed checks the same way you would deposit a paper check that arrives in the mail, following your office's standard check deposit process.\n5. Verify Deposit: Before sending the deposit slip, confirm that the deposit slip matches the total number of checks and total dollar amount.\n6. Send Deposit Slip: Once eChecks have been deposited, send only the deposit slip back to RCM.\n\nIMPORTANT\nYou do not need to include a coversheet or EOBs. ONLY the deposit slip in the same exact email thread you received.",
    comments:[], history:[{action:"SOP Created",by:"Jenny Organista",at:"2026-03-09T00:00:00Z"},{action:"Imported from SharePoint RCM SOPs",by:"System",at:"2026-04-16T13:00:00Z"}],
  },
  {
    id:"sop-r02", policyNumber:"FDH-BILL-2026-008", title:"Patient Financing Options",
    category:"Billing", status:"approved", version:"1.0",
    createdAt:"2026-02-02T00:00:00Z", updatedAt:"2026-02-02T00:00:00Z",
    createdBy:"Jenny Organista", approvedAt:"2026-02-02T00:00:00Z", approvedBy:"RCM Director",
    tags:["patient financing","payment","Cherry","third party","RCM","billing","collections"],
    content:"PURPOSE\nProvide a simple, consistent process for dental office admin team members on when and how to offer a third-party financing option, while prioritizing upfront payment.\n\nPROCEDURE\nPresent the Treatment Plan:\n- Always review the full treatment plan and patient portion first.\n- Clearly explain the total cost and expected timing of treatment.\n\nOption 1: Pay in Full Upfront (Preferred)\n- Primary goal is to collect payment in full upfront, prior to scheduling any procedure.\n- If patient shows hesitation, offer an upfront payment discount starting at 2%, up to 5%.\n- If patient agrees, collect payment and proceed.\n\nOption 2: Pay as You Go (Second Best)\n- If paying in full is not an option, offer to collect payment at each visit before treatment begins.\n- No discount is offered for this option.\n\nOption 3: Third Party Financing (Last Option)\n- Only offer to patients if Options 1 and 2 don't work.\n- Balance $200+: 6 months, no interest\n- Balance $1,000+: 9 months, no interest\n- Balance $2,500+: 12 months, no interest\n- 36, 48, or 60 month options available but include APR based on credit score.\n\nSPECIAL RULE - Low Credit Score:\n- May only be offered if balance is $2,000+.\n- Promotional length may be offered.\n- Do NOT offer Cherry to Subprime Credit patients with balance under $2,000 due to higher promotional rates to the company.",
    comments:[], history:[{action:"SOP Created",by:"Jenny Organista",at:"2026-02-02T00:00:00Z"},{action:"Imported from SharePoint RCM SOPs",by:"System",at:"2026-04-16T13:00:00Z"}],
  },
  {
    id:"sop-r03", policyNumber:"FDH-BILL-2026-009", title:"Billing Correction SOP",
    category:"Billing", status:"approved", version:"1.0",
    createdAt:"2026-03-19T00:00:00Z", updatedAt:"2026-03-19T00:00:00Z",
    createdBy:"Nicole Fratangelo-Berardi", approvedAt:"2026-03-19T00:00:00Z", approvedBy:"RCM Director",
    tags:["billing corrections","adjustments","claims","RCM"],
    content:"PURPOSE\nDefine the process for submitting and processing billing corrections when incorrect services have been posted.\n\nSCOPE\nBilling department and front office staff.\n\nNOTE\nFull correction form template, required fields, and approval workflow are maintained in the source document on SharePoint: Billing Correction SOP.pdf and Billing Corrections Form.",
    comments:[], history:[{action:"SOP Created",by:"Nicole Fratangelo-Berardi",at:"2026-03-19T00:00:00Z"},{action:"Imported from SharePoint RCM SOPs",by:"System",at:"2026-04-16T13:00:00Z"}],
  },
  {
    id:"sop-r04", policyNumber:"FDH-BILL-2026-010", title:"Claims Pending Report (Denticon)",
    category:"Billing", status:"approved", version:"1.0",
    createdAt:"2025-11-18T00:00:00Z", updatedAt:"2025-11-18T00:00:00Z",
    createdBy:"Jenny Organista", approvedAt:"2025-11-18T00:00:00Z", approvedBy:"RCM Director",
    tags:["claims","pending","Denticon","report","RCM","billing"],
    content:"PURPOSE\nDefine the procedure for retrieving the claims pending report from Denticon to track outstanding insurance claims.\n\nSCOPE\nRCM team members with Denticon access.\n\nNOTE\nFull step-by-step instructions with screenshots are maintained in the source document on SharePoint: How to retrieve the claims pending to create Report (Denticon).docx.",
    comments:[], history:[{action:"SOP Created",by:"Jenny Organista",at:"2025-11-18T00:00:00Z"},{action:"Imported from SharePoint RCM SOPs",by:"System",at:"2026-04-16T13:00:00Z"}],
  },
  {
    id:"sop-r05", policyNumber:"FDH-BILL-2026-011", title:"Insurance Checks Scan Cover Page",
    category:"Billing", status:"approved", version:"1.0",
    createdAt:"2026-01-28T00:00:00Z", updatedAt:"2026-01-28T00:00:00Z",
    createdBy:"Crystal Bartlett", approvedAt:"2026-01-28T00:00:00Z", approvedBy:"RCM Director",
    tags:["insurance checks","scanning","cover page","RCM","billing"],
    content:"PURPOSE\nProvide a standardized cover page template for scanning insurance checks to RCM for processing.\n\nSCOPE\nFront office staff responsible for scanning and sending insurance checks to the RCM team.\n\nNOTE\nFull cover page template and instructions are maintained in the source document on SharePoint: Insurance Checks Scan Cover Page.docx.",
    comments:[], history:[{action:"SOP Created",by:"Crystal Bartlett",at:"2026-01-28T00:00:00Z"},{action:"Imported from SharePoint RCM SOPs",by:"System",at:"2026-04-16T13:00:00Z"}],
  },
  {
    id:"sop-r06", policyNumber:"FDH-BILL-2026-012", title:"Insurance Payment Posting & Reconciliation SOP",
    category:"Billing", status:"approved", version:"1.0",
    createdAt:"2026-02-19T00:00:00Z", updatedAt:"2026-02-19T00:00:00Z",
    createdBy:"Jenny Organista", approvedAt:"2026-02-19T00:00:00Z", approvedBy:"RCM Director",
    tags:["insurance","payment posting","reconciliation","EOB","EFT","RCM","billing"],
    content:"PURPOSE\nDefine the detailed procedures for insurance payment posting and daily reconciliation within the RCM department.\n\nSCOPE\nRCM team members responsible for payment posting.\n\nNOTE\nFull posting procedures, reconciliation checklists, and reporting templates are maintained in the source document on SharePoint: Insurance Payment Posting & Reconciliation SOP.docx.",
    comments:[], history:[{action:"SOP Created",by:"Jenny Organista",at:"2026-02-19T00:00:00Z"},{action:"Imported from SharePoint RCM SOPs",by:"System",at:"2026-04-16T13:00:00Z"}],
  },
  {
    id:"sop-r07", policyNumber:"FDH-BILL-2026-013", title:"Patient Financing Verbiage",
    category:"Billing", status:"approved", version:"1.0",
    createdAt:"2026-02-02T00:00:00Z", updatedAt:"2026-02-02T00:00:00Z",
    createdBy:"Jenny Organista", approvedAt:"2026-02-02T00:00:00Z", approvedBy:"RCM Director",
    tags:["patient financing","verbiage","scripts","front office","RCM","billing"],
    content:"PURPOSE\nProvide standardized scripts and verbiage for presenting patient financing options during treatment plan discussions.\n\nSCOPE\nFront office and treatment coordinators.\n\nNOTE\nFull scripting templates and conversation guides are maintained in the source document on SharePoint: Patient Financing Verbiage.docx.",
    comments:[], history:[{action:"SOP Created",by:"Jenny Organista",at:"2026-02-02T00:00:00Z"},{action:"Imported from SharePoint RCM SOPs",by:"System",at:"2026-04-16T13:00:00Z"}],
  },
  {
    id:"sop-r08", policyNumber:"FDH-BILL-2026-014", title:"Payment Posting Policy",
    category:"Billing", status:"approved", version:"1.0",
    createdAt:"2025-12-09T00:00:00Z", updatedAt:"2025-12-09T00:00:00Z",
    createdBy:"Jenny Organista", approvedAt:"2025-12-09T00:00:00Z", approvedBy:"RCM Director",
    tags:["payment posting","policy","insurance","RCM","billing"],
    content:"PURPOSE\nEstablish the payment posting policy and standards for the RCM department.\n\nSCOPE\nAll RCM team members responsible for posting payments.\n\nNOTE\nFull policy details, timelines, and quality standards are maintained in the source document on SharePoint: Payment Posting Policy (1).docx.",
    comments:[], history:[{action:"SOP Created",by:"Jenny Organista",at:"2025-12-09T00:00:00Z"},{action:"Imported from SharePoint RCM SOPs",by:"System",at:"2026-04-16T13:00:00Z"}],
  },
  {
    id:"sop-r09", policyNumber:"FDH-BILL-2026-015", title:"Prior Authorization SOP",
    category:"Billing", status:"approved", version:"1.0",
    createdAt:"2026-03-20T00:00:00Z", updatedAt:"2026-03-20T00:00:00Z",
    createdBy:"Nicole Fratangelo-Berardi", approvedAt:"2026-03-20T00:00:00Z", approvedBy:"RCM Director",
    tags:["prior auth","authorization","insurance","pre-approval","RCM","billing"],
    content:"PURPOSE\nDefine the process for obtaining prior authorization from insurance companies before scheduled procedures.\n\nSCOPE\nRCM team and front office staff involved in insurance verification.\n\nNOTE\nFull prior authorization procedures, required documentation, and follow-up timelines are maintained in the source document on SharePoint: prior auth SOP.pdf.",
    comments:[], history:[{action:"SOP Created",by:"Nicole Fratangelo-Berardi",at:"2026-03-20T00:00:00Z"},{action:"Imported from SharePoint RCM SOPs",by:"System",at:"2026-04-16T13:00:00Z"}],
  },
  {
    id:"sop-r10", policyNumber:"FDH-BILL-2026-016", title:"Sending Insurance Checks to RCM",
    category:"Billing", status:"approved", version:"1.0",
    createdAt:"2026-01-22T00:00:00Z", updatedAt:"2026-01-22T00:00:00Z",
    createdBy:"Jenny Organista", approvedAt:"2026-01-22T00:00:00Z", approvedBy:"RCM Director",
    tags:["insurance checks","RCM","mailing","scanning","checklist","billing"],
    content:"PURPOSE\nDefine the standard process and checklist for office staff to send insurance checks to the centralized RCM team for processing.\n\nSCOPE\nAll front office staff at Freedom Dental Health locations.\n\nNOTE\nFull mailing/scanning procedures and required checklist are maintained in the source document on SharePoint: Sending Ins. Checks to RCM SOP & Check List.docx.",
    comments:[], history:[{action:"SOP Created",by:"Jenny Organista",at:"2026-01-22T00:00:00Z"},{action:"Imported from SharePoint RCM SOPs",by:"System",at:"2026-04-16T13:00:00Z"}],
  },
  {
    id:"sop-r11", policyNumber:"FDH-BILL-2026-017", title:"EOB Training Material",
    category:"Billing", status:"approved", version:"1.0",
    createdAt:"2026-02-23T00:00:00Z", updatedAt:"2026-02-23T00:00:00Z",
    createdBy:"Jenny Organista", approvedAt:"2026-02-23T00:00:00Z", approvedBy:"RCM Director",
    tags:["EOB","training","explanation of benefits","insurance","RCM","billing"],
    content:"PURPOSE\nProvide training materials for understanding and processing Explanation of Benefits (EOB) documents from insurance companies.\n\nSCOPE\nRCM team members and billing staff.\n\nNOTE\nFull training materials, examples, and reference guides are maintained in the EOB Training Material folder on SharePoint.",
    comments:[], history:[{action:"SOP Created",by:"Jenny Organista",at:"2026-02-23T00:00:00Z"},{action:"Imported from SharePoint RCM SOPs",by:"System",at:"2026-04-16T13:00:00Z"}],
  },
];
